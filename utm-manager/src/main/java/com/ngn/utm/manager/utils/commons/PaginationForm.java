...
public class PaginationForm extends VerticalLayout implements FormInterface{
	...
	private ButtonTemplate btnFirst = new ButtonTemplate(new SvgIcon(LineAwesomeIconUrl.ANGLE_DOUBLE_LEFT_SOLID));
	private ButtonTemplate btnPrevious = new ButtonTemplate(new SvgIcon(LineAwesomeIconUrl.ANGLE_LEFT_SOLID));
	private ButtonTemplate btnNext = new ButtonTemplate(new SvgIcon(LineAwesomeIconUrl.ANGLE_RIGHT_SOLID));
	private ButtonTemplate btnLast = new ButtonTemplate(new SvgIcon(LineAwesomeIconUrl.ANGLE_DOUBLE_RIGHT_SOLID));
	private IntegerField txtPageNumber = new IntegerField();
	private Span spanSlash = new Span("/");
	private Span spanPage = new Span();

	private ButtonTemplate btnTrigger = new ButtonTemplate();
...
//		hLeftLayout.getStyle().set("margin-left", "20px");
	...
	public ButtonTemplate getBtnTrigger() {
		return btnTrigger;
	}
	public int getSkip() {
		return skip;
