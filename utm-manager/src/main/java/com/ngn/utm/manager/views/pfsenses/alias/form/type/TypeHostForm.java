...
public class TypeHostForm extends TypeBaseForm implements FormInterface{
	private static final long serialVersionUID = 1L;
	private HeaderComponent headerHost = new HeaderComponent("Host(s)");
	...
	private void createLayout() {
		...
		String width = "100px";
		vLayout.add(createKeyValue("Hint", "Enter as many hosts as desired. Hosts must be "
				+ "specified by their IP address or fully qualified domain name (FQDN). "
				+ "FQDN hostnames are periodically re-resolved and updated. "
				+ "If multiple IPs are returned by a DNS query, all are used. "
				+ "An IP range such as 192.168.1.1-192.168.1.10 or a small "
				+ "subnet such as 192.168.1.16/28 may also be entered and a list "
				+ "of individual IP addresses will be generated.", width, true));
	...
	public List<TypeGeneralModel> getListValues(){
		List<TypeGeneralModel> listData = new ArrayList<>();
