...
public class TypeNetworkForm extends TypeBaseForm implements FormInterface{
	private static final long serialVersionUID = 1L;
	private HeaderComponent headerHost = new HeaderComponent("Network(s)");
	...
	private void createLayout() {
		...
		String width = "100px";
		vLayout.add(createKeyValue("Hint", "Networks are specified in CIDR format. "
				+ "Select the CIDR mask that pertains to each entry. "
				+ "/32 specifies a single IPv4 host, "
				...
				+ "/32 mask for IPv4 or /128 for IPv6. "
				+ "An IP range such as 192.168.1.1-192.168.1.254 may also be entered and a "
				+ "list of CIDR networks will be derived to fill the range.", width, true));
