...
public class TypePortForm extends TypeBaseForm implements FormInterface{
	private static final long serialVersionUID = 1L;
	private HeaderComponent headerHost = new HeaderComponent("Port(s)");
	...
	private void createLayout() {
		...
		String width = "100px";
		vLayout.add(createKeyValue("Hint", "Enter ports as desired, "
				+ "with a single port or port range per entry. "
				+ "Port ranges can be expressed by separating with a colon.", width, true));
