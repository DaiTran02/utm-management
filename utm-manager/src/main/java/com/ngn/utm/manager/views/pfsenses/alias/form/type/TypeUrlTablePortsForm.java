...
public class TypeUrlTablePortsForm extends TypeBaseForm implements FormInterface{
	private static final long serialVersionUID = 1L;
	private HeaderComponent headerHost = new HeaderComponent("URL Table(Ports)");
	...
	private void createLayout() {
		...
		String width = "100px";
		vLayout.add(createKeyValue("Hint", "Enter a single URL containing a list of Port numbers and/or Port ranges. After saving, the URL will be downloaded.\r\n"
