...
public class TypeUrlipsForm extends TypeBaseForm implements FormInterface{
	private static final long serialVersionUID = 1L;
	private HeaderComponent headerHost = new HeaderComponent("URL(IPs)");
	...
	private void createLayout() {
		...
		vLayout.add(createKeyValue("Hint", "Enter as many URLs as desired. "
				...
				+ "Use only with small sets of IP addresses (less than 3000).", width, true));
