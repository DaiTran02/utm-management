...
public class FirewallLogForm extends VerticalLayout implements FormInterface{
	...
	public FirewallLogForm(ApiLogService apiLogService) {
	...
	private Component createGrid() {
		...
		grid.addColumn(ModelParsingLog::getSt2).setHeader("Interface").setWidth("150px").setFlexGrow(0);
		grid.addColumn(ModelParsingLog::getSt3).setHeader("Rule").setWidth("90px").setFlexGrow(0);
		grid.addColumn(ModelParsingLog::getSt4).setHeader("Source");
